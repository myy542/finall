...
double grossSalary = basicSalary + allowances + overtimePay + bonuses;
        double grossSalarydeductions = 0;
double netSalary = grossSalarydeductions;

System.out.print("Enter net_salary: ");
double netsalary = getValidPositiveDoubleInput(sc);
...
double grossSalary = basicSalary + allowances + overtimePay + bonuses;
        double grossSalarydeductions = 0;
double netSalary = grossSalarydeductions;
String sql = "UPDATE tbl_gpayslip SET basic_salary = ?, allowances = ?, deductions = ?, overtime_pay = ?, bonuses = ?, gross_salary = ?, net_salary = ? WHERE payslip_id = ?";
...
String sql = "DELETE FROM tbl_gpayslip WHERE payslip_id = ?";
